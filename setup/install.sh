...
while true; do
    ...
    case $yn in
        [Yy]* ) echo "Creating CRON job . . ."; sudo crontab -l > xron && echo "@reboot sudo /usr/share/themes/Xenite/setup/update.sh" >> xron && crontab xron && rm xron; echo "DONE WITH INSTALLING!"; break;;
